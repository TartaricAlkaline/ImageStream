...
public class JpegImageWriterSpi extends ImageWriterSpi {
    ...
    private static final String WRITER_CLASS_NAME = "rip.ysm.imagestream.jpeg.JpegImageWriter";
    private static final String[] READER_SPI_NAMES = {"rip.ysm.imagestream.jpeg.JpegImageReaderSpi"};
    ...
    public String getDescription(Locale locale) {
        return "JPEG Image Writer (ImageStream)";
    }
}
